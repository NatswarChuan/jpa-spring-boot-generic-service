 ...
 *
 * <p>Interface này định nghĩa các phương thức chuyển đổi cơ bản giữa DTO và Entity, hỗ trợ việc
 * tách biệt giữa lớp dữ liệu (Entity) và lớp giao diện (DTO). Sử dụng {@link BeanUtils} để tự động
 * copy dữ liệu nếu không có logic đặc biệt.
 *
...
public interface IDto<E> {
   ...
   *
   * <p>Mặc định trả về null. Các lớp con CẦN ghi đè để khởi tạo Entity mới.
   *
   ...
   *
   * <p>Mặc định sử dụng {@link BeanUtils#copyProperties(Object, Object)} để copy các field cùng
   * tên.
   *
