 ...
 * <p>
 * Cung cấp endpoint chuẩn để tạo mới một thực thể vào hệ thống.
 * </p>
 *
 ...
 * @author NatswarChuan
 */
public interface ICreateController<E, ID, CREATE_REQ extends IDto<E>> extends IBaseController<E, ID> {
         ...
         * <p>
         * Payload gửi lên sẽ được validate trước khi xử lý.
         * Trả về thông tin chi tiết của thực thể vừa được tạo thành công.
         * </p>
         *
        ...
        default <S extends ICreateService<E, ID>> S getCreateService() {
                if (getBaseService() instanceof ICreateService) {
                        ...
                        throw new HttpException(HttpStatus.INTERNAL_SERVER_ERROR,
                                        "Service không implement ICreateService");
                }
        }
}
