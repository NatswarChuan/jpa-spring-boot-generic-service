 ...
 * <p>
 * Cung cấp endpoint tiêu chuẩn để xóa một bản ghi dựa trên ID.
 * </p>
 *
...
public interface IDeleteController<E, ID> extends IBaseController<E, ID> {
         ...
         * <p>
         * Logic xóa (Soft delete hay Hard delete) phụ thuộc vào cấu hình của Service.
         * </p>
         *
         * @param id ID của bản ghi cần xóa.
         * @return ResponseEntity với HTTP Status 204 (No Content) nếu thành công.
         */
        @Operation(summary = "Xóa bản ghi", description = "Xóa bản ghi dựa trên ID (Soft delete hoặc Hard delete tùy cấu hình).")
        @ApiResponses(value = {
        ...
        default <S extends IDeleteService<E, ID>> S getDeleteService() {
                if (getBaseService() instanceof IDeleteService)
                        ...
                        throw new HttpException(HttpStatus.INTERNAL_SERVER_ERROR,
                                        "Service không implement IDeleteService");
        }
}
