...
/**
 * Interface tổng hợp (Aggregate Interface) cho các Controller, cung cấp đầy đủ
 * các thao tác CRUD cơ bản.
 * <p>
 * Interface này kế thừa và kết hợp các chức năng từ các interface thành phần:
 * </p>
 * <ul>
 * <li>{@link ICreateController}: Chức năng tạo mới.</li>
 * <li>{@link IReadDetailController}: Chức năng xem chi tiết.</li>
 * <li>{@link IReadSummaryController}: Chức năng xem danh sách và filter.</li>
 * <li>{@link IUpdateController}: Chức năng cập nhật.</li>
 * <li>{@link IDeleteController}: Chức năng xóa.</li>
 * </ul>
 *
...
public interface IController<E, ID, CREATE_REQ extends IDto<E>, UPDATE_REQ extends IDto<E>>
        extends ICreateController<E, ID, CREATE_REQ>, IReadDetailController<E, ID>,
        IReadSummaryController<E, ID>, IUpdateController<E, ID, UPDATE_REQ>, IDeleteController<E, ID> {
    /**
     * Lấy instance của Service cơ sở xử lý các nghiệp vụ chung.
     * 
     * @param <S> Kiểu dữ liệu thực tế của Service, phải kế thừa
     *            {@link IBaseService}.
     ...
     * <p>
     * Mặc định, phương thức này trả về {@link #getBaseService()} vì Service cơ sở
     * thường implement tất cả các interface.
     * </p>
     * 
    ...
    default <S extends ICreateService<E, ID>> S getCreateService() {
        ...
        throw new HttpException(HttpStatus.INTERNAL_SERVER_ERROR,
                "Service không implement IService");
    }

    /**
     * Cung cấp Service xử lý nghiệp vụ Xem chi tiết.
     * <p>
     * Mặc định, phương thức này trả về {@link #getBaseService()}.
     * </p>
     * 
     ...
     * </p>
     * 
     * @param <S> Kiểu dữ liệu của Service, phải kế thừa
     *            {@link IReadSummaryService}.
