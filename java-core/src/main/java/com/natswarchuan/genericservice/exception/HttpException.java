...
/**
 * Lớp ngoại lệ tùy chỉnh đại diện cho các lỗi xảy ra trong quá trình xử lý yêu cầu HTTP.
 *
 * <p>Lớp này kế thừa từ {@link RuntimeException}, cho phép ném ra ngoại lệ ở bất kỳ đâu trong logic
 * nghiệp vụ mà không cần bắt buộc khai báo `throws` trong chữ ký phương thức.
 *
 * <p>Nó bao gồm thông tin chi tiết về mã trạng thái HTTP, thông điệp lỗi và có thể chứa dữ liệu bổ
 * sung để phục vụ cho việc gỡ lỗi hoặc hiển thị phía frontend.
 *
 * @author NatswarChuan
 */
@Data
