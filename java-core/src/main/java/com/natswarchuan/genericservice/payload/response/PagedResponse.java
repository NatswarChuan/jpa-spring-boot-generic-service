 ...
 *
 * <p>Lớp này được sử dụng để trả về một tập hợp dữ liệu được phân trang cùng với các metadata hỗ
 * trợ việc hiển thị ở phía giao diện (như tổng số phần tử, số trang, trạng thái trang hiện tại).
 *
  ...
  public static class PagedResponseBuilder<T> {
    ...
    public PagedResponse<T> build() {
      return new PagedResponse<>(
          content, page, size, totalElements, totalPages, first, last, empty, numberOfElements);
    }
  }
