 ...
 *
 * <ul>
 *   <li><b>page</b>: Số trang hiện tại (bắt đầu từ 0).
 *   <li><b>size</b>: Số lượng bản ghi trên mỗi trang.
 *   <li><b>search</b>: Từ khóa tìm kiếm chung.
 *   <li><b>sort</b>: Cấu hình sắp xếp (trường và chiều).
 * </ul>
 *
 * @author NatswarChuan
 */
public class BaseRequestParam {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BaseRequestParam)) return false;
