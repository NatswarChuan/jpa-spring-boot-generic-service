import{_ as s}from"./CodeBlock-BQU6-ZC9.js";import{r,c as a,o as n,b as t,d as i,e as o,a as d}from"./index-D9vsZoXm.js";const p={id:"service-layer",class:"scroll-mt-20 mb-16"},m={id:"core-service",class:"mb-10 scroll-mt-24"},u={id:"service-hooks",class:"mb-10 scroll-mt-24"},b={class:"space-y-4"},y={__name:"ServiceLayerSection",setup(v){const l=r(`package com.example.demo.service;
...
`);return(g,e)=>(n(),a("section",p,[e[6]||(e[6]=t("h2",{class:"text-3xl font-bold text-slate-900 border-b pb-4 mb-8"},"4. Service Layer",-1)),e[7]||(e[7]=t("p",{class:"text-slate-600 italic mb-6"},"Xử lý logic nghiệp vụ và tích hợp các life-cycle hooks.",-1)),t("article",m,[e[0]||(e[0]=t("h3",{class:"text-xl font-bold text-slate-800 mb-3"},"4.1. Basic Service",-1)),e[1]||(e[1]=t("p",{class:"text-slate-600 mb-3"},[o("Kế thừa "),t("code",null,"AbService"),o(" để có sẵn các phương thức CRUD chuẩn hóa.")],-1)),i(s,{filename:"ProductService.java",code:l.value},null,8,["code"]),e[2]||(e[2]=t("div",{class:"bg-green-50 border-l-4 border-green-500 p-4 mb-4 mt-4 text-sm text-green-800 shadow-sm"},[t("strong",null,"Tips:"),o(" Bạn không nhất thiết phải tạo Interface cho Service. "),t("code",null,"AbService"),o(" đã cung cấp đủ các phương thức thông dụng. ")],-1))]),t("article",u,[e[4]||(e[4]=t("h3",{class:"text-xl font-bold text-slate-800 mb-3"},"4.2. Life-cycle Hooks",-1)),e[5]||(e[5]=t("p",{class:"text-slate-600 mb-4"},' Framework cho phép "can thiệp" vào luồng xử lý mà không cần override toàn bộ phương thức. ',-1)),t("div",b,[e[3]||(e[3]=d('<div class="bg-slate-900 rounded-lg p-4 font-mono text-sm text-green-400"><p class="text-slate-500 mb-2">// Các hook hỗ trợ trong AbService:</p><ul class="space-y-1"><li>- <span class="text-blue-400">beforeCreate</span>(E entity)</li><li>- <span class="text-blue-400">afterCreate</span>(E entity)</li><li>- <span class="text-blue-400">beforeUpdate</span>(E newEntity, E oldEntity)</li><li>- <span class="text-blue-400">afterUpdate</span>(E savedEntity, E oldEntity)</li><li>- <span class="text-blue-400">beforeDelete</span>(E entity)</li><li>- <span class="text-blue-400">afterDelete</span>(E entity)</li></ul></div><p class="text-sm text-slate-600">Ví dụ: Tự động tính toán hoặc gửi thông báo:</p>',2)),i(s,{filename:"ProductService.java",code:c.value},null,8,["code"])])])]))}};export{y as default};
