...
`);return(v,e)=>(d(),i("section",m,[e[7]||(e[7]=t("h2",{class:"text-3xl font-bold text-slate-900 border-b pb-4 mb-8"},"8. Response Handling",-1)),e[8]||(e[8]=t("p",{class:"text-slate-600 mb-6"}," Cung cấp cấu trúc phản hồi thống nhất và cơ chế xử lý lỗi tập trung. ",-1)),t("article",g,[e[0]||(e[0]=c(`<h3 class="text-xl font-bold text-slate-800 mb-3">8.1. Response Structures</h3><p class="text-slate-600 mb-3"> Thư viện cung cấp 2 lớp wrap chuẩn: <code>HttpApiResponse</code> cho đối tượng đơn/list và <code>PagedResponse</code> cho phân trang. </p><div class="bg-slate-50 p-4 rounded-lg border border-slate-200 mb-4"><h4 class="font-bold text-slate-700 mb-2 text-sm">Cấu trúc JSON (HttpApiResponse)</h4><pre class="text-xs text-slate-600 font-mono bg-white p-3 rounded border border-slate-100 overflow-x-auto">{
