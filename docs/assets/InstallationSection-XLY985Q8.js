...
}</pre></div></div><div class="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-r-lg"><p class="text-yellow-800"><strong>Quan trọng:</strong> Hãy kiểm tra và sử dụng phiên bản (Release Tag) mới nhất tại <a href="https://github.com/NatswarChuan/jpa-spring-boot-generic-service/releases" target="_blank" class="underline font-bold text-blue-700"> GitHub Releases <i class="fas fa-external-link-alt ml-1"></i></a></p></div>`,5)])])}const p=e(l,[["render",r]]);export{p as default};
