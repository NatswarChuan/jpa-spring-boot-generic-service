import{u as m,e as r,c as x,o as _,a as e,t as l,b as a,d as i,f as d}from"./index-CgjH2hXA.js";import{_ as n}from"./CodeBlock-CwfY0IEK.js";const g={class:"mb-16"},y={id:"controller-layer",class:"scroll-mt-20"},h={class:"text-3xl font-bold text-slate-900 border-b pb-4 mb-8"},f={class:"text-slate-600 italic mb-6"},v={id:"controller-hierarchy",class:"mb-10 scroll-mt-24"},$={class:"text-xl font-bold text-slate-800 mb-3"},C=["innerHTML"],P={class:"mb-8 p-6 bg-slate-50 rounded-xl border border-slate-200 shadow-inner"},w={class:"grid grid-cols-1 lg:grid-cols-12 gap-6 items-center"},R={class:"lg:col-span-3 flex flex-col items-center p-4 bg-white rounded-lg border border-slate-200 shadow-sm"},L={class:"font-bold text-slate-500 text-xs uppercase mb-3 tracking-wide"},S={class:"lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-4"},T={class:"bg-white p-5 rounded-lg border-2 border-indigo-100 hover:border-indigo-300 transition-colors shadow-sm relative group"},I={class:"absolute -top-3 -right-3 bg-indigo-600 text-white text-xs font-bold px-2 py-1 rounded shadow-sm z-10"},M={class:"text-xs text-slate-500 border-t border-slate-100 pt-2 mt-2"},H=["innerHTML"],k={class:"bg-white p-5 rounded-lg border-2 border-slate-200 hover:border-slate-300 transition-colors shadow-sm relative group"},D={class:"absolute -top-3 -right-3 bg-slate-500 text-white text-xs font-bold px-2 py-1 rounded shadow-sm z-10"},j={class:"text-xs text-slate-500 border-t border-slate-100 pt-2 mt-2"},B={id:"core-controller",class:"mb-10 scroll-mt-24"},E={class:"text-xl font-bold text-slate-800 mb-3"},q=["innerHTML"],O=["innerHTML"],A={id:"controller-traits",class:"mb-10 scroll-mt-24"},N={class:"text-xl font-bold text-slate-800 mb-3"},V={class:"text-slate-600 mb-6"},G={class:"mb-8 overflow-hidden bg-white border border-slate-200 rounded-lg shadow-sm"},U={class:"w-full text-left text-sm"},z={class:"bg-slate-50 text-slate-700 font-bold border-b border-slate-200"},F={class:"p-3"},J={class:"p-3"},K={class:"p-3"},Q={class:"divide-y divide-slate-100"},W={class:"p-3 font-mono text-blue-600"},X={class:"p-3 text-slate-600"},Y={class:"p-3 font-mono text-cyan-600"},Z={class:"p-3 text-slate-600"},ee={class:"p-3 font-mono text-purple-600"},te={class:"p-3 text-slate-600"},se={class:"p-3 font-mono text-orange-600"},le={class:"p-3 text-slate-600"},oe={class:"p-3 font-mono text-red-600"},re={class:"p-3 text-slate-600"},ae=["innerHTML"],de={class:"font-bold text-slate-700 mb-4"},ne={class:"grid grid-cols-1 md:grid-cols-2 gap-6"},ie={class:"bg-slate-50 p-5 rounded-lg border border-slate-200"},ce={class:"flex items-center mb-3"},be={class:"font-bold text-slate-800"},pe={class:"text-xs text-slate-500 mb-3 ml-11"},ue={class:"bg-slate-50 p-5 rounded-lg border border-slate-200"},me={class:"flex items-center mb-3"},xe={class:"font-bold text-slate-800"},_e={class:"text-xs text-slate-500 mb-3 ml-11"},ge={id:"custom-api",class:"mb-10 scroll-mt-24"},ye={class:"text-xl font-bold text-slate-800 mb-3"},he={class:"text-slate-600 mb-4"},Ce={__name:"ControllerLayerSection",setup(fe){const{t:o}=m(),c=r(()=>`package com.example.demo.controller;
