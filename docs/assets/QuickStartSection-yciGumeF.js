...
}`}}));return(i,l)=>(a(),n("section",h,[t("h2",q,o(i.$t("quick_start.title")),1),t("p",{class:"text-lg text-slate-600 mb-8",innerHTML:i.$t("quick_start.intro")},null,8,y),t("div",P,[t("div",R,[(a(!0),n(v,null,_(s.value,(A,c)=>(a(),n("button",{key:c,onClick:B=>r.value=c,class:b(["px-6 py-3 text-sm font-bold whitespace-nowrap transition-colors",r.value===c?"bg-white text-blue-600 border-b-2 border-blue-600":"text-slate-500 hover:text-slate-700 hover:bg-slate-100"])},o(c),11,x))),128))]),t("div",D,[s.value[r.value]?(a(),g(f,{key:0,filename:s.value[r.value].filename,code:s.value[r.value].code,language:"java",class:"!m-0 rounded-none border-0"},null,8,["filename","code"])):u("",!0)]),s.value[r.value]?(a(),n("div",C,[t("h4",S,o(i.$t("quick_start.explain_label"))+": "+o(s.value[r.value].title),1),t("p",{class:"text-sm text-blue-800",innerHTML:s.value[r.value].desc},null,8,I)])):u("",!0)]),t("div",w,[t("p",L,o(i.$t("quick_start.more_info")),1),t("a",T,[k(o(i.$t("quick_start.view_details"))+" ",1),l[0]||(l[0]=t("i",{class:"fas fa-arrow-right ml-2"},null,-1))])])]))}};export{E as default};
