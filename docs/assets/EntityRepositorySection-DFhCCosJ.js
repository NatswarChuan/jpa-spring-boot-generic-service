...
`),c=s(`package com.example.demo.repository;
...
`);return(w,e)=>(d(),l("section",f,[e[5]||(e[5]=t("h2",{class:"text-3xl font-bold text-slate-900 border-b pb-4 mb-8"},"3. Entity & Repository Layer",-1)),e[6]||(e[6]=t("p",{class:"text-slate-600 italic mb-6"},"Ánh xạ với bảng trong database và Repository JPA cho module Product.",-1)),t("div",g,[r(b)]),t("article",y,[e[0]||(e[0]=t("h3",{class:"text-xl font-bold text-slate-800 mb-3"},"3.1. Entity Definition",-1)),e[1]||(e[1]=t("p",{class:"text-slate-600 mb-3"},"Định nghĩa cấu trúc bảng và các mối quan hệ (ManyToOne, OneToMany).",-1)),r(a,{filename:"Product.java",code:o.value},null,8,["code"])]),t("article",h,[e[2]||(e[2]=t("h3",{class:"text-xl font-bold text-slate-800 mb-3"},"3.2. Repository Implementation",-1)),e[3]||(e[3]=t("p",{class:"text-slate-600 mb-3"},"Sử dụng Spring Data JPA Repository.",-1)),r(a,{filename:"ProductRepository.java",code:c.value},null,8,["code"]),e[4]||(e[4]=t("div",{class:"bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-4 mt-4 text-sm text-yellow-800"},[t("strong",null,"Lưu ý:"),i(" Repository bắt buộc phải extends "),t("code",null,"JpaSpecificationExecutor"),i(" để hỗ trợ bộ lọc nâng cao (Specification). ")],-1))])]))}};export{T as default};
