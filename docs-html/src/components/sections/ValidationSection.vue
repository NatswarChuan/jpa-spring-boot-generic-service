  ...
  <section id="validation" class="scroll-mt-20 mb-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      ...
      <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm relative overlow-hidden">
        ...
        <span
          class="bg-slate-100 text-slate-600 px-2 py-0.5 rounded text-xs font-mono mb-3 inline-block">@Annotation</span>
      ...
      <!-- Level 2 -->
      <div
        class="bg-white rounded-xl border border-blue-200 p-5 shadow-sm relative overlow-hidden ring-1 ring-blue-100">
        <div class="absolute top-0 right-0 p-3 opacity-10">
        ...
        <span
          class="bg-blue-100 text-blue-600 px-2 py-0.5 rounded text-xs font-mono mb-3 inline-block">Specification</span>
      ...
      <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm relative overlow-hidden">
        ...
        <span class="bg-amber-100 text-amber-600 px-2 py-0.5 rounded text-xs font-mono mb-3 inline-block">Native
          SQL</span>
    ...
    <article id="val-advanced" class="mb-10 scroll-mt-24">
      ...
      <p class="text-sm text-slate-600 mb-2" v-html="$t('validation.advanced.sql.desc')"></p>
