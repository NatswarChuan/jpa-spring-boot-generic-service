<template>
  <section id="service-layer" class="scroll-mt-20 mb-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:border-blue-400 transition-colors">
          <div class="flex items-center gap-2 mb-3">
            <span class="bg-amber-100 text-amber-700 px-2 py-1 rounded text-xs font-bold uppercase">Interface</span>
            <h4 class="font-bold text-slate-800">IReadSummaryService</h4>
          </div>
          ...
          <ul class="text-sm text-slate-600 space-y-2 mb-4">
            ...
            <li class="flex items-center"><span class="text-green-500 mr-2">✓</span> {{
              $t('service_layer.base.menu.read_summary.features') }}</li>
          </ul>
        </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:border-blue-400 transition-colors">
          <div class="flex items-center gap-2 mb-3">
            <span class="bg-orange-100 text-orange-700 px-2 py-1 rounded text-xs font-bold uppercase">Interface</span>
            <h4 class="font-bold text-slate-800">IReadDetailService</h4>
          </div>
          <p class="text-sm text-slate-500 mb-4 h-10">{{ $t('service_layer.base.menu.read_detail.question') }}</p>
          <ul class="text-sm text-slate-600 space-y-2 mb-4">

            <li class="flex items-center"><span class="text-green-500 mr-2">✓</span> {{
              $t('service_layer.base.menu.read_detail.features') }}</li>
          </ul>
        </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:border-blue-400 transition-colors">
          <div class="flex items-center gap-2 mb-3">
            <span class="bg-pink-100 text-pink-700 px-2 py-1 rounded text-xs font-bold uppercase">Interface</span>
            <h4 class="font-bold text-slate-800">ICreateService</h4>
          </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:border-blue-400 transition-colors">
          <div class="flex items-center gap-2 mb-3">
            <span class="bg-purple-100 text-purple-700 px-2 py-1 rounded text-xs font-bold uppercase">Interface</span>
            <h4 class="font-bold text-slate-800">IUpdateService</h4>
          </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:border-blue-400 transition-colors">
          <div class="flex items-center gap-2 mb-3">
            <span class="bg-red-100 text-red-700 px-2 py-1 rounded text-xs font-bold uppercase">Interface</span>
            <h4 class="font-bold text-slate-800">IDeleteService</h4>
          </div>
          <p class="text-sm text-slate-500 mb-4 h-10">{{ $t('service_layer.base.menu.delete.question') }}</p>
          <ul class="text-sm text-slate-600 space-y-2 mb-4">
            <li class="flex items-center"><span class="text-green-500 mr-2">✓</span> delete (Soft/Hard)</li>
          </ul>
        </div>

        <!-- Level 6: Full (Aggregator) -->
        <div
          class="bg-indigo-50 rounded-xl border border-indigo-200 p-5 shadow-sm relative overflow-hidden col-span-1 md:col-span-2 lg:col-span-2">
          <div class="absolute right-0 top-0 w-24 h-24 bg-indigo-100 rounded-bl-full -mr-10 -mt-10 opacity-50"></div>
          <div class="flex items-center gap-2 mb-3 relative z-10">
            <span class="bg-indigo-600 text-white px-2 py-1 rounded text-xs font-bold uppercase shadow">{{
              $t('service_layer.base.menu.full.rec') }}</span>
    ...
    <article id="service-hooks" class="mb-10 scroll-mt-24">
      ...
      <p class="text-slate-600 mb-6" v-html="$t('service_layer.hooks.desc')"></p>
        ...
        <div class="space-y-6">
          ...
          <div class="bg-slate-50 rounded-xl p-6 border border-slate-200">
            ...
            <div class="relative pl-4 border-l-2 border-slate-300 space-y-6">
              ...
              <div class="relative">
                <div
                  class="absolute -left-[25px] top-0 w-4 h-4 rounded-full bg-amber-500 border-2 border-white shadow-sm ring-1 ring-amber-200">
                </div>
                <div class="text-sm font-bold text-amber-700 text-xs mb-1 bg-amber-50 inline-block px-2 py-0.5 rounded">
                  HOOK: beforeCreate/Update/Delete</div>
              ...
              <div class="relative">
                <div
                  class="absolute -left-[25px] top-0 w-4 h-4 rounded-full bg-purple-500 border-2 border-white shadow-sm ring-1 ring-purple-200">
                </div>
                <div
                  class="text-sm font-bold text-purple-700 text-xs mb-1 bg-purple-50 inline-block px-2 py-0.5 rounded">
                  HOOK: afterCreate/Update/Delete</div>
          ...
          <div class="bg-sky-50 rounded-xl p-6 border border-sky-200">
            ...
            <div class="relative pl-4 border-l-2 border-sky-300 space-y-6">
              ...
              <div class="relative">
                <div
                  class="absolute -left-[25px] top-0 w-4 h-4 rounded-full bg-sky-500 border-2 border-white shadow-sm ring-1 ring-sky-200">
                </div>
                <div
                  class="text-sm font-bold text-sky-700 text-xs mb-1 bg-white inline-block px-2 py-0.5 rounded border border-sky-100">
                  HOOK: afterReadEntity(entity)</div>
              ...
              <div class="relative">
                <div
                  class="absolute -left-[25px] top-0 w-4 h-4 rounded-full bg-indigo-500 border-2 border-white shadow-sm ring-1 ring-indigo-200">
                </div>
                <div
                  class="text-sm font-bold text-indigo-700 text-xs mb-1 bg-white inline-block px-2 py-0.5 rounded border border-indigo-100">
                  HOOK: afterReadDto(dto)</div>
        ...
        <div class="space-y-4">
          <div class="bg-indigo-50 p-4 rounded-lg border border-indigo-100 mb-2">
            ...
            <ul class="grid grid-cols-1 gap-2 text-xs font-mono text-indigo-800">
              <li><span class="text-amber-600">beforeCreate</span> / <span class="text-purple-600">afterCreate</span>
              </li>
              <li><span class="text-purple-600">afterReadEntity</span> / <span
                  class="text-purple-600">afterReadDto</span></li>
              <li><span class="text-amber-600">beforeUpdate</span> / <span class="text-purple-600">afterUpdate</span>
              </li>
              <li><span class="text-amber-600">beforeDelete</span> / <span class="text-purple-600">afterDelete</span>
              </li>
            </ul>
          </div>
