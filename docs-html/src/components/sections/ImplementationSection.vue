<template>
  <section id="implementation" class="scroll-mt-20 mb-16">
    <h2 class="text-3xl font-bold text-slate-900 border-b pb-4 mb-8">2. Hướng dẫn triển khai</h2>
    ...
    <article id="step2-1" class="mb-10 scroll-mt-24">
      <h3 class="text-xl font-bold text-slate-800 mb-3">2.1. Định nghĩa Entity</h3>
    ...
    <article id="step2-2" class="mb-10 scroll-mt-24">
      <h3 class="text-xl font-bold text-slate-800 mb-3">2.2. Tạo Repository</h3>
    ...
    <article id="step2-3" class="mb-10 scroll-mt-24">
      <h3 class="text-xl font-bold text-slate-800 mb-3">2.3. Tạo Service Interface</h3>
    ...
    <article id="step2-4" class="mb-10 scroll-mt-24">
      <h3 class="text-xl font-bold text-slate-800 mb-3">2.4. Tạo Service Implementation</h3>
